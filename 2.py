...
def test_coze(cli: SyncHTTPClient, coze_api_base: str, coze_api_token: str, bot_id: str):
    ...
    req = httpx.Request(
        ...
        json={
            ...
            "user_id": "user_id",
            "additional_messages": [
                Message.build_user_question_text("hello").model_dump(),
            ],
            "stream": True,
        },
        headers={
...
cli = SyncHTTPClient(transport=transport)
print(json.dumps(test_coze(cli, coze_api_base, coze_api_token, bot_id), indent="  "))
print(json.dumps(test_coze(cli, coze_api_base, coze_api_token, bot_id), indent="  "))
print(json.dumps(test_coze(cli, coze_api_base, coze_api_token, bot_id), indent="  "))
