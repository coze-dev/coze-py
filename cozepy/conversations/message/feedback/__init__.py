...
class ConversationsMessagesFeedbackClient(object):
    ...
    def create(
        ...
        *,
        ...
        return self._requester.request("post", url, False, body=body, cast=CreateConversationMessageFeedbackResp)
    ...
    def delete(
        ...
        *,
        ...
        return self._requester.request("delete", url, False, cast=DeleteConversationMessageFeedbackResp)
...
class AsyncMessagesFeedbackClient(object):
    ...
    async def create(
        ...
        *,
        ...
        return await self._requester.arequest("post", url, False, body=body, cast=CreateConversationMessageFeedbackResp)
    ...
    async def delete(
        ...
        *,
        ...
        return await self._requester.arequest("delete", url, False, cast=DeleteConversationMessageFeedbackResp)
