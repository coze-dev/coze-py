"""
This example is for describing how to delete voiceprint group.
"""
...
delete_voiceprint_group_resp = coze.audio.voiceprint_groups.delete(
    group_id=voiceprint_group_id,
)
print("logid", delete_voiceprint_group_resp.response.logid)
